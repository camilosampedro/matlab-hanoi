function [ hanoi_towers ] = user_move_disk( hanoi_towers )
...
hanoi_towers = move_disk(hanoi_towers, source_n, target_n);
end

function [ hanoi_towers ] = move_disk( hanoi_towers, source_pin, target_pin)
...
if (source_pin == target_pin)
    ...
    if(dest_disk < source_disk)
        ...
        hanoi_towers(:, target_pin) = put_disk(hanoi_towers(:, target_pin), source_disk);
    end
end
end
